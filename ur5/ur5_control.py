...
if __name__=='__main__':
    ...
    def get_search_idx(search_ratio, mode):
        ...
        # breakpoint()
        if mode == 'binary':
            sorted_search_idx.append(search_idx[0])
            taken_idx.append(0)
        # elif mode == 'golden':
        #     sorted_search_idx = []
        #     taken_idx = []
